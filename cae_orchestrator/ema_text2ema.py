...
SCHEMA = {
    ...
    "rotorType":  {"kind": "enum", "opts": ["kaefig", "schleifring"], "def": "kaefig",
                   "geom": True, "adv": True,
                   "desc": "ASM-Läuferbauform: kaefig=Kurzschlussläufer, schleifring=gewickelter Läufer mit Anlasswiderstand"},
    "rotorSkewSlots": {"kind": "num", "lo": -1, "hi": 2, "def": -1, "geom": True, "adv": True,
    ...
    "polHoeheAnteil": {"kind": "num", "lo": 0.15, "hi": 0.65, "def": 0.38,
                   "geom": True, "adv": True,
                   "desc": "Höhe des Schenkelpols (Schuh + Körper) als Anteil des Läuferradius (EESM, GSM). Vorher gab es das nicht: das Joch kam aus dem Fluss und der Pol war der Rest — gemessen 0,50 statt der 0,38 eines gebauten Läufers. Das Joch bleibt Bedingung: reicht es für den Fluss nicht, gewinnt der Fluss (joch_bindet)"},
    "polSchuhAnteil": {"kind": "num", "lo": 0.08, "hi": 0.50, "def": 0.26,
                   "geom": True, "adv": True,
                   "desc": "Höhe des Polschuhs als Anteil der Polhöhe (EESM, GSM) — in der Literatur h_s2/(h_s2+h_bd). Höher = mehr Überstand über die Spule, weniger Platz für den Kern"},
    "polKernAnteil": {"kind": "num", "lo": 0.25, "hi": 0.85, "def": 0.38,
                   "geom": True, "adv": True,
                   "desc": "Breite des Polkerns als Anteil der Polschuhbreite (EESM, GSM) — OBERE Schranke. 0,38 nach einer gerechneten und gebauten Maschine (Energies 2025, 18, 3673, Tab. 5: w_bd/w_se = 11,5/31,5). Schmaler = mehr Platz für die Erregerwicklung; ob er erreichbar ist, entscheidet die Kernflussdichte (B_kern_T), die als eigene, UNTERE Schranke dagegenhält"},
    ...
    "armatureCurrentDensity": {"kind": "num", "lo": 1, "hi": 20, "def": 5, "geom": True, "adv": True,
                   "desc": "Stromdichte der Ankerwicklung [A/mm²] (GSM) — bestimmt Leiterquerschnitt und Nuttiefe"},
