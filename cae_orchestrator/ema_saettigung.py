...
def als_text(e: dict) -> str:
    ...
    a("")
    a("  ⚠ SPANNE, gemessen an drei Wegen — und KEINER ist beglaubigt:")
    a("      Formel (Flusserhaltung, analytisches B_gap)   1,00 x")
    a("      aus dem FDM-Feld integriert                   0,56 x")
    a("      aus einem koerperangepassten Elmer-Netz        0,29 x")
    a("    Die Formel liegt also HOECHSTENS richtig und sonst zu hoch: als Tor")
    a("    irrt sie auf der sicheren Seite (sie meldet eher Saettigung), als")
    a("    ausgewiesene Zahl ist sie um bis zu Faktor 3,5 unsicher.")
    a("    Ursache ist die Eichung (max|Br_fdm| auf _analytical_Bgap, einen")
    a("    Flachdachwert) — s. BEFUNDE.md 13.09.2026.")
    if e["gesaettigt"]:
        a("")
